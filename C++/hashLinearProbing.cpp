...
//insert function
  ...
  node* searchItem(int key){
    ...
    {
      for (int i = (index + 1) % tableSize; i != index; i = (i + 1) % tableSize)//linearly probe 
      {
...
int main(int argc, char *argv[])
{
  ...
  HashTable hash;
    ...
    ofstream outInsertA ("hashLinearinsertB.txt");
    ofstream outSearchA ("hashLinearsearchB.txt");
    ofstream collisions("LinearCollisionsB.txt");
